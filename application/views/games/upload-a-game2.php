			...
			<!-- here form -->
				<div class= "uploadGameFormContent">
						...
						<div class="spaceHeightTextArea">
							...
							<div class="floatLeft"> 
								<textarea class="uploadGameText" name="description"><?php if (isset($_POST['description'])) { echo $_POST['description']; }?></textarea>
							</div>
						</div>
						...
						<div class="spaceHeightTextArea">
							...
							<div class="floatLeft"> 
								<textarea class="uploadGameText" name="instructions" ><?php if (isset($_POST['instructions'])) { echo $_POST['instructions']; } ?></textarea>
							</div>
						</div>
						...
						<div class="spaceHeight2">
							...
							<div class="floatLeft"> 
								<input type="text" name="tags" class="inputUploadGame" value="<?php if (isset($_POST['tags'])) { echo $_POST['tags']; }?>" /><br />
						...
						?>
							...
							<div class="spaceHeight">
								...
								<div class="floatLeft"> 
									<input type="text" name="height" class="inputUploadGameSize" value="<?php if (isset($_POST['height'])) { echo $_POST['height']; } ?>" maxlength="3" />
								</div>
							</div>
							...
							<div class="spaceHeight">
								...
								<div class="floatLeft"> 
									<input type="text" name="width" class="inputUploadGameSize" value="<?php if (isset($_POST['width'])) { echo $_POST['width']; } ?>" maxlength="3" />
						...
						?>
							...
							<div class="spaceHeight">
								<div class="spaceWidth">Game height:</div> 
								<div class="floatLeft"> 
									<input type="text" name="height" class="inputUploadGameSize" maxlength="3" value="<?php if (isset($_POST['height'])) { echo $_POST['height']; } ?>" />
								</div>
							</div>
							...
							<div class="spaceHeight">
								<div class="spaceWidth">Game width:</div> 
								<div class="floatLeft"> 
									<input type="text" name="width" class="inputUploadGameSize" maxlength="3" value="<?php if (isset($_POST['width'])) { echo $_POST['width']; } ?>" />
								</div>
							</div>
						<?php
							}
