...
* @author Luis Vazquez
* Date : 08/07/2014
* Thumb class: 	The purpose of this class is to Upload files like images and games
* @version 1.0
...
class UploadFile{
	...
	*/
	...
	private function uploadFile(){
		...
		if($form_file !=""){
			...
			$newfile = "/home/content/09/10884609/html/levelingapp.com/" . $this->pathImages ."/". $this->newFileName;
	...
	*/
	...
	public function setFileType($typeUpload){
	...
	*/
	...
	public function setWidth($minWidth){
...
if(!$uploadFile->execute($_FILES, "image")){
